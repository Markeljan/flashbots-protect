  ...
  return (
    <div className="relative p-8 pt-2 pb-6">
      <div className="absolute top-0 left-0 h-full w-full z-[-1]">
        <div className="absolute top-0 left-0 w-full border-t border-l border-r h-[calc(100%-24px)] border-[var(--ifm-color-emphasis-200)]"></div>
      ...
      </div>
      {
        title && (
          <div className="text-center h-28 flex flex-col justify-between">
            ...
            <span className="flex-grow text-2xl leading-[1.25] font-medium font-serif">{title}</span>
